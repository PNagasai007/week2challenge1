...
const MyCounter=()=>{
  ...
  const MyfetchCounter=useCallback(async ()=>{
    try{
      const response=await axios.get('http://localhost:9000/api/myCounter');
  ...
  const incrementCounter = useCallback(async () => {
    try {
      await axios.post('http://localhost:9000/api/mycounter/increment');
  ...
  const decrementCounter = useCallback(async () => {
    try {
      await axios.post('http://localhost:9000/api/mycounter/decrement');
...
const Counter = () => {
  ...
  const incrementCounter = useCallback(async () => {
    try {
      await axios.post('http://localhost:9000/api/counter/increment');
  ...
  const decrementCounter = useCallback(async () => {
    try {
      await axios.post('http://localhost:9000/api/counter/decrement');
